...
<head>
  ...
  <link href="${URL}assets/frontend/pages/css/style-revolution-slider.css" rel="stylesheet"><!-- metronic revo slider styles -->
...
<body class="corporate">
    ...
    <div class="page-slider margin-bottom-40">
      <div class="fullwidthbanner-container revolution-slider">
        <div class="fullwidthabnner">
          <ul id="revolutionul">
            <!-- THE NEW SLIDE -->
            <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="${URL}assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
              <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
              <img src="${URL}assets/frontend/pages/img/revolutionslider/bg9.jpg" alt="">
              ...
              <div class="caption lfb"
                ...
                data-start="1000" 
                data-easing="easeOutExpo">
                <img src="${URL}assets/frontend/pages/img/revolutionslider/lady.png" alt="Image 1">
              </div>
            </li>    
            ...
            <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="${URL}assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
              <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
              <img src="${URL}assets/frontend/pages/img/revolutionslider/bg1.jpg" alt="">
              ...
              <div class="caption lfb"
                ...
                data-start="1000" 
                data-easing="easeOutExpo">
                <img src="${URL}assets/frontend/pages/img/revolutionslider/man-winner.png" alt="Image 1">
              </div>
            </li>

            <!-- THE SECOND SLIDE -->
            <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-delay="9400" data-thumb="${URL}assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">                        
              <img src="${URL}assets/frontend/pages/img/revolutionslider/bg2.jpg" alt="">
              ...
              <div class="caption lfr slide_item_right" 
                ...
                <img src="${URL}assets/frontend/pages/img/revolutionslider/mac.png" alt="Image 1">
              </div>
              <div class="caption lfr slide_item_right" 
                data-x="580" 
                data-y="245" 
                ...
                data-start="2000" 
                data-easing="easeOutBack">
                <img src="${URL}assets/frontend/pages/img/revolutionslider/ipad.png" alt="Image 1">
              </div>
              <div class="caption lfr slide_item_right" 
                data-x="735" 
                data-y="290" 
                ...
                data-start="2500" 
                data-easing="easeOutBack">
                <img src="${URL}assets/frontend/pages/img/revolutionslider/iphone.png" alt="Image 1">
              </div>
              <div class="caption lfr slide_item_right" 
                data-x="835" 
                data-y="230" 
                ...
                data-start="3000" 
                data-easing="easeOutBack">
                <img src="${URL}assets/frontend/pages/img/revolutionslider/macbook.png" alt="Image 1">
              </div>
              <div class="caption lft slide_item_right" 
                ...
                data-start="5000" 
                data-easing="easeOutBack">
                <img src="${URL}assets/frontend/pages/img/revolutionslider/hint1-red.png" id="rev-hint1" alt="Image 1">
              </div>                        
              <div class="caption lfb slide_item_right" 
                ...
                data-start="5500" 
                data-easing="easeOutBack">
                <img src="${URL}assets/frontend/pages/img/revolutionslider/hint2-red.png" id="rev-hint2" alt="Image 1">
              </div>
            </li>
                        
            <!-- THE THIRD SLIDE -->
            <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="${URL}assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
              <img src="${URL}assets/frontend/pages/img/revolutionslider/bg3.jpg" alt="">
              ...
              <a class="caption lfr btn yellow slide_btn" href=""
                ...
                data-y="280"
                        ...
                        <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="${URL}assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
                            <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
                            <img src="${URL}assets/frontend/pages/img/revolutionslider/bg4.jpg" alt="">                        
                            ...
                            <div class="caption lft start"  
                                 ...
                                 data-start="2000" 
                                 data-easing="easeOutBack"  >
                                 <img src="${URL}assets/frontend/pages/img/revolutionslider/iphone_left.png" alt="Image 2">
                            </div>
                            ...
                            <div class="caption lft start"  
                                 ...
                                 data-start="2400" 
                                 data-easing="easeOutBack"  >
                                 <img src="${URL}assets/frontend/pages/img/revolutionslider/iphone_right.png" alt="Image 3">
                            </div>                        
                        </li>
                </ul>
          ...
          <div class="col-md-9">
            <div class="owl-carousel owl-carousel3">
              <div class="recent-work-item">
                <em>
                  <img src="${URL}assets/frontend/pages/img/works/img1.jpg" alt="Amazing Project" class="img-responsive">
                  <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                  <a href="${URL}assets/frontend/pages/img/works/img1.jpg" class="fancybox-button" title="Project Name #1" data-rel="fancybox-button"><i class="fa fa-search"></i></a>
                </em>
              ...
              <div class="recent-work-item">
                <em>
                  <img src="${URL}assets/frontend/pages/img/works/img2.jpg" alt="Amazing Project" class="img-responsive">
                  <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                  <a href="${URL}assets/frontend/pages/img/works/img2.jpg" class="fancybox-button" title="Project Name #2" data-rel="fancybox-button"><i class="fa fa-search"></i></a>
                </em>
                <a class="recent-work-description" href="#">
                  <strong>Amazing Project</strong>
                  <b>Agenda corp.</b>
              ...
              <div class="recent-work-item">
                <em>
                  <img src="${URL}assets/frontend/pages/img/works/img3.jpg" alt="Amazing Project" class="img-responsive">
                  <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                  <a href="${URL}assets/frontend/pages/img/works/img3.jpg" class="fancybox-button" title="Project Name #3" data-rel="fancybox-button"><i class="fa fa-search"></i></a>
                </em>
                <a class="recent-work-description" href="#">
                  <strong>Amazing Project</strong>
                  <b>Agenda corp.</b>
              ...
              <div class="recent-work-item">
                <em>
                  <img src="${URL}assets/frontend/pages/img/works/img4.jpg" alt="Amazing Project" class="img-responsive">
                  <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                  <a href="${URL}assets/frontend/pages/img/works/img4.jpg" class="fancybox-button" title="Project Name #4" data-rel="fancybox-button"><i class="fa fa-search"></i></a>
                </em>
                <a class="recent-work-description" href="#">
                  <strong>Amazing Project</strong>
                  <b>Agenda corp.</b>
              ...
              <div class="recent-work-item">
                <em>
                  <img src="${URL}assets/frontend/pages/img/works/img5.jpg" alt="Amazing Project" class="img-responsive">
                  <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                  <a href="${URL}assets/frontend/pages/img/works/img5.jpg" class="fancybox-button" title="Project Name #5" data-rel="fancybox-button"><i class="fa fa-search"></i></a>
                </em>
                <a class="recent-work-description" href="#">
                  <strong>Amazing Project</strong>
                  <b>Agenda corp.</b>
              ...
              <div class="recent-work-item">
                <em>
                  <img src="${URL}assets/frontend/pages/img/works/img6.jpg" alt="Amazing Project" class="img-responsive">
                  <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                  <a href="${URL}assets/frontend/pages/img/works/img6.jpg" class="fancybox-button" title="Project Name #6" data-rel="fancybox-button"><i class="fa fa-search"></i></a>
                </em>
                <a class="recent-work-description" href="#">
                  <strong>Amazing Project</strong>
                  <b>Agenda corp.</b>
              ...
              <div class="tab-pane row fade in active" id="tab-1">
                <div class="col-md-3 col-sm-3">
                  <a href="assets/temp/photos/img7.jpg" class="fancybox-button" title="Image Title" data-rel="fancybox-button">
                    <img class="img-responsive" src="${URL}assets/frontend/pages/img/photos/img7.jpg" alt="">
                  </a>
                </div>
              ...
              <div class="tab-pane row fade" id="tab-2">
                ...
                <div class="col-md-3 col-sm-3">
                  <a href="assets/temp/photos/img10.jpg" class="fancybox-button" title="Image Title" data-rel="fancybox-button">
                    <img class="img-responsive" src="${URL}assets/frontend/pages/img/photos/img10.jpg" alt="">
                  </a>
                </div>
              </div>
              ...
              <div class="carousel-inner">
                <div class="active item">
                  ...
                  <div class="carousel-info">
                    <img class="pull-left" src="${URL}assets/frontend/pages/img/people/img1-small.jpg" alt="">
                    <div class="pull-left">
                ...
                <div class="item">
                  ...
                  <div class="carousel-info">
                    <img class="pull-left" src="${URL}assets/frontend/pages/img/people/img5-small.jpg" alt="">
                    <div class="pull-left">
                ...
                <div class="item">
                  ...
                  <div class="carousel-info">
                    <img class="pull-left" src="${URL}assets/frontend/pages/img/people/img2-small.jpg" alt="">
                    <div class="pull-left">
          ...
          <div class="col-md-9">
            <div class="owl-carousel owl-carousel6-brands">
              <div class="client-item">
                <a href="#">
                  <img src="${URL}assets/frontend/pages/img/clients/client_1_gray.png" class="img-responsive" alt="">
                  <img src="${URL}assets/frontend/pages/img/clients/client_1.png" class="color-img img-responsive" alt="">
                </a>
              </div>
              <div class="client-item">
                <a href="#">
                  <img src="${URL}assets/frontend/pages/img/clients/client_2_gray.png" class="img-responsive" alt="">
                  <img src="${URL}assets/frontend/pages/img/clients/client_2.png" class="color-img img-responsive" alt="">
                </a>
              </div>
              <div class="client-item">
                <a href="#">
                  <img src="${URL}assets/frontend/pages/img/clients/client_3_gray.png" class="img-responsive" alt="">
                  <img src="${URL}assets/frontend/pages/img/clients/client_3.png" class="color-img img-responsive" alt="">
                </a>
              </div>
              <div class="client-item">
                <a href="#">
                  <img src="${URL}assets/frontend/pages/img/clients/client_4_gray.png" class="img-responsive" alt="">
                  <img src="${URL}assets/frontend/pages/img/clients/client_4.png" class="color-img img-responsive" alt="">
                </a>
              </div>
              <div class="client-item">
                <a href="#">
                  <img src="${URL}assets/frontend/pages/img/clients/client_5_gray.png" class="img-responsive" alt="">
                  <img src="${URL}assets/frontend/pages/img/clients/client_5.png" class="color-img img-responsive" alt="">
                </a>
              </div>
              <div class="client-item">
                <a href="#">
                  <img src="${URL}assets/frontend/pages/img/clients/client_6_gray.png" class="img-responsive" alt="">
                  <img src="${URL}assets/frontend/pages/img/clients/client_6.png" class="color-img img-responsive" alt="">
                </a>
              </div>
              <div class="client-item">
                <a href="#">
                  <img src="${URL}assets/frontend/pages/img/clients/client_7_gray.png" class="img-responsive" alt="">
                  <img src="${URL}assets/frontend/pages/img/clients/client_7.png" class="color-img img-responsive" alt="">
                </a>
              </div>
              <div class="client-item">
                <a href="#">
                  <img src="${URL}assets/frontend/pages/img/clients/client_8_gray.png" class="img-responsive" alt="">
                  <img src="${URL}assets/frontend/pages/img/clients/client_8.png" class="color-img img-responsive" alt="">
                </a>
              </div>                  
            </div>
          </div>          
    ...
    <script src="${URL}assets/global/plugins/slider-revolution-slider/rs-plugin/js/jquery.themepunch.plugins.min.js" type="text/javascript"></script>
    <script src="${URL}assets/global/plugins/slider-revolution-slider/rs-plugin/js/jquery.themepunch.revolution.min.js" type="text/javascript"></script> 
    <script src="${URL}assets/global/plugins/slider-revolution-slider/rs-plugin/js/jquery.themepunch.tools.min.js" type="text/javascript"></script> 
